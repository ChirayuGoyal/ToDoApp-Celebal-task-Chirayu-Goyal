...
//const url = "mongodb+srv://ChirayuGoyal:<password>@cluster0.kyv1z.mongodb.net/?retryWrites=true&w=majority"
...
app.get("/", function(req, res)
{
  ...
  if(req.session.isLoggedIn)
  {
    ...
    {
      res.render("home.ejs",{ data: todos, user: req.session.user });
    })
